...
def main(src, dst, label, at):
    ...
    A("; ===========================================================================")
    A("")
    A(f"{label}_PX0     = {x0}                ; where the art was AUTHORED, in the")
    A(f"{label}_PY0     = {y0}                ;   player's portrait view - the input to")
    A(";                                 ;   the turn below, kept so a harness can")
    A(";                                 ;   undo it without knowing the placement")

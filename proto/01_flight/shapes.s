...
; the original triangle, carried forward as the default outline: nose 25 px
; forward, base 14 px back and 12 either side of centre - (-25,0), (14,-12),
; (14,12). Add up to 10 more vertices (13 total) with the shape editor or by
; hand; SHIP_VN says how many of them are read.
SHIP_VN     = 3
SHIP_SHAPE: .byte   <-25,     0,    14,   <-12,    14,    12
; === END GENERATED ===

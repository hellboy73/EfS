...
; =============================================================================
; PURPOSE: measure what is playable, nothing else. Inherited whole from proto
; 02 — the camera, the speed tiers, the starfield, the rocks and their
; collisions — with the HUD RADAR added on top, which is what this bench is
; for. Every number this thing shows is meant to be argued with.
;
